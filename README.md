...
## Hinweis zum technischen Teil

Die folgenden Installationsbeispiele stammen aus einer älteren Testphase und sind vor allem als historische Orientierung gedacht.  
Sie zeigen die Grundidee, wie schnell sich ein kleiner vServer für Self-Hosted-Livestreaming nutzen lässt.

**Wichtig:** Bitte nicht blind auf diese alten Befehle vertrauen.  
Für aktuelle Installationsschritte, Sicherheitsaspekte und empfohlene Konfigurationen immer die offiziellen Dokumentationen von **datarhei Restreamer** und **Owncast** prüfen.

Dieses Repository soll vor allem zum Ausprobieren anregen – nicht die offizielle Dokumentation ersetzen.

---

## Historische Installationsnotizen
### datarhei Restreamer auf einem kleinen Hetzner-vServer

Älteres Praxisbeispiel zur Installation von datarhei Restreamer auf einem kleinen Hetzner-vServer.
...
Älteres Beispiel, ungetestet auf aktuellem Stand:
